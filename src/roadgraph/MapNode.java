...
class MapNode implements Comparable {
	...
	static boolean useHeuristics = false;
	...
	/**
	 * Because we compare nodes using their location, we also may use their
	 * location for HashCode.
	 * 
	...
	public int compareTo(Object o) {
		...
		/*
		 * double distanceThis = this.getActualDistance(); double distanceOther
		 * = m.getActualDistance();
		 * 
		 * 
		 * if (distanceThis > distanceOther) return 1; else if (distanceThis <
		 * distanceOther) return -1; else return 0;
		 */
